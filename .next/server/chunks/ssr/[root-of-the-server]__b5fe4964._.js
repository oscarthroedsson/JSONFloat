...
function calculateNodeSizeFromText(node) {
    ...
    const height = (node.values.length + node.breakOuts.length) * document.body.removeChild(tempNode);
    console.log({
...
function buildObjectNode({ type, values, breakOuts }) {
    ...
    header.style.cssText = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$StyleObjects$2f$header$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NCheaderCSSText"];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b5fe4964._.js.map